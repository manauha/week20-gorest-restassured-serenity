...
public class UserCRUDTestWithSteps extends TestBase {
    ...
    static String name = TestUtils.getRandomValue() + "Neil";
    static String email = TestUtils.getRandomValue() + "nc@test.com";
    ...
    public void test04_UpdateUser() {
        name = "Meera" + TestUtils.getRandomValue();
        email = "Meera_Mohan@test.com" + TestUtils.getRandomValue();
